...
void factory::create_world(world** sim)
{
  ...
  cars[1] = new car(roads[0], AHEAD, (float)roads[0]->length - 3);
  cars[2] = new car(roads[0], AHEAD, (float)roads[0]->length - 5);
  cars[3] = new car(roads[0], AHEAD, (float)roads[0]->length - 7);

  cars[5] = new car(roads[12], AHEAD, (float)roads[0]->length - 1);
//  cars[6] = new car(roads[12], AHEAD, (float)roads[0]->length - 3);
//   cars[7] = new car(roads[12], AHEAD, (float)roads[0]->length - 5);
//   cars[8] = new car(roads[12], AHEAD, (float)roads[0]->length - 7);
