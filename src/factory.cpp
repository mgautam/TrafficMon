...
void factory::create_world(world** sim)
{
  ...
  cars[0] = new car(roads[road_count/4+2*SQUARE_SIZE+3], RIGHT, 0);
  cars[1] = new car(roads[road_count/4+2*SQUARE_SIZE+3], RIGHT, 0);
  cars[2] = new car(roads[road_count/4+2*SQUARE_SIZE+3], RIGHT, 0);
